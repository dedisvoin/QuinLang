...
# QuinLang
QuinLang — это современный алгоритмический язык программирования полностью написанный на python, разработанный специально для обучения школьников основам программирования. Он сочетает в себе простоту и доступность с мощными возможностями, которые помогут детям освоить базовые принципы программирования и развить логическое мышление.
